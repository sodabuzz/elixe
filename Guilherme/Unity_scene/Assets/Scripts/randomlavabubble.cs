...
public class randomlavabubble: MonoBehaviour {
	...
	void spawnGameObject () {
		...
		if (retournement < 5 && spawnedObjectReverse != null ){
			...
			Instantiate (spawnedObject, transform.position + new Vector3(Random.Range (minHorizontal, maxHorizontal),Random.Range (minVertical, maxVertical),Random.Range (minForward, maxForward)), Quaternion.Euler(0, 0, Random.Range(minAngle,maxAngle)));
		}
